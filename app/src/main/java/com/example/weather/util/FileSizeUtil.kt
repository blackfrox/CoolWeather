...
object FileSizeUtil {
    ...
    fun getAutoFileOrFilesSize(filePath: String): String {
        ...
        return Formatter.formatFileSize(MyApp.instance, blockSize)
    }


    fun getAutoFileOrFilesSize(array: Array<String>): String {
        ...
        return Formatter.formatFileSize(MyApp.instance, totalSize)
    }
